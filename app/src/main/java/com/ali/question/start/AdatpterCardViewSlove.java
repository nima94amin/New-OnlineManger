 ...
 */
public class AdatpterCardViewSlove extends RecyclerView.Adapter<ViewHolder>  {
    ...
    public AdatpterCardViewSlove(Context context)
    {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        holder.tittle.setText(Start.sloved.get(position));
